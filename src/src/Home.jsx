          ...
          <Grid container spacing={5}>
            ...
            <Grid data-aos="zoom-in" item xs={12} sm={12} sx={{ pb: 20 }}>
              <Typography
                ...
                gutterBottom
              >
                Szeroki wachlarz umiejętności, pełna obsługa projektowa
              </Typography>
              <Typography variant="h6" align="left" color="white" paragraph>
                Oferujemy usługi w zakresie projektowania architektury,
                architektury wnętrz, animacji, wizualizacji, modelowania 3D oraz
                projektowania stron internetowych. Współpracujemy z deweloperami
                w pełnym zakresie, pozwala to na zaprezentowanie klientowi
                spoistego designu począwszy od proponowanego budynku, poprzez
                sposób jego zaprezentowania kończąc na projekcie strony.
              </Typography>
            </Grid>
            ...
            <Grid data-aos="zoom-in" item xs={12} sm={12} sx={{ pb: 10 }}>
              ...
              <Typography variant="h6" align="left" color="white" paragraph>
                Nasza praca została nie tylko doceniona przez naszych klientów,
                ale również przez magazyny architektoniczne.
                <br />
